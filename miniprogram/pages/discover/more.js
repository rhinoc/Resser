var e = wx.cloud.database(),
  t = (e.command, wx.getStorageSync("openid")),
  l = wx.getStorageSync("rss_list") || [],
  r = require("../../utils/xml2json.js"),
  a = require("../../utils/util.js"),
  i = require("../../utils/utils-days.js"),
  o = wx.getStorageSync("history") || [],
  n = new Array(),
  c = [];
...
Page({
  ...
  onChange: function(r) {
    if (0 == c.rssed) l.push(c);
    else
      for (var a in l) l[a].rssUrl == c.rssUrl && l.splice(a, 1),
        console.log("删除");
